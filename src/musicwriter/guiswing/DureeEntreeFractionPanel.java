...
/**
 * Petit panneau qui indique où en est la saisie d'une fraction pour donner une
 * durée
 * @author  proprietaire
 */
public class DureeEntreeFractionPanel extends javax.swing.JPanel {
    ...
    private final javax.swing.JPanel thisPanel = this;
    ...
    ActionListener action = new ActionListener ()
      {
        ...
        public void actionPerformed (ActionEvent event)
        {
            if(c > 0)
            {
                ...
                partitionPanel.remove(thisPanel);
  ...
  DureeEntreeFractionPanel(Controller partitionPanel, Duree duree) {
        initComponents();
    ...
    private void setDuree(Duree duree)
    {
        this.duree = duree;
    ...
    public static void tryDureePanel(KeyEvent evt, Controller partitionPanel) {

 ...
 * @author Ancmin
 */
public class ImageLoaderSwing extends ImageLoader {

    
    
    static private HashMap<String, ImageIcon> imgs = new HashMap<String, ImageIcon>();
    static private ImageIcon imgDefault = ImageLoaderSwing.getImageIcon("note_erreur.png");
...
//    }
    ...
    static public ImageIcon createImageIcon(String filename)
    {
    ...
    static public ImageIcon getImageIcon(String filename)
    {
        ...
        {
            ImageIcon imageCreated = createImageIcon(filename);
            imgs.put(filename, imageCreated);
            return imageCreated;
        }
...
/**
    ...
    static public ImageIcon getImageIconPNG(String filename)
    {
        try
        {
            URL url = ImageLoaderSwing.class.getResource(cheminComplet(filename));
    ...
    static private ImageIcon getImageIconNullSiRien(String filename)
    {
        try
        {
                return new ImageIcon(ImageLoaderSwing.class.getResource(cheminComplet(filename)));
    ...
    public static void createInstance() {
        img = new ImageLoaderSwing();
    }

    @Override
    protected musicwriter.gui.Image getImageFromString(String string) {
        return new ImageSwing(getImageIcon(string));
    }
